...
public class GeradorDePagamento {
	...
	//Metodos estaticos são ruim de serem testados, geralmente utilizamos um abstracao para isso
	//O Clock é uma abstracao do Java para api do LocalDate, com ele conseguimos mockar o LocalDate
	private Clock clock;
